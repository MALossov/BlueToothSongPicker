...
extern WZSerialPort w;
extern string data1;
extern int volume;
extern bool setVolum(int level);
/****************************************************************************************************************
...
{
	data1[0] = NULL;
	GuiMusicPlayer *w = new GuiMusicPlayer();
...
//单片机事件
void GuiMusicPlayer::StmFunction() {
	while (1) {
		data1 = w.receive().c_str();
		cout << data1<<endl;
	}
}
